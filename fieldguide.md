...
**Figure_geological-setting**. Location of the NW Iberian complexes and other European Variscides during the Palaeozoic convergence (Díez Fernández & Arenas, 2015).
...
**Fig_lherzolite-outcrop**. Loose boulder exposing an example of "impregnated" (Cpx-rich) harzburgite with green Srp-rich veins with boudinaged pyroxenite layers in the *Herbeira* massif near *Punta Robaliceira* (Tilhac, 2017).
...
**Fig_dissolved-pyroxenite**. Chromite precipitated _via_ incongruent melting or dissolution of pyroxenes at the termination of a pre-existing pyroxenite layer in the lower dunite at *Punta Robaliceira* (Tilhac, 2017).
...
**Fig_PGE**. **a.** Sketch depicting the stratigraphic interpretation of the W part of the *Herbeira* massif as a lower-crustal cumulate sequence based on increasing PGE enrichment and fractionation (Moreno et al. 2001). Only representative PGE distribution (chondrite-normalized) and the highest concentration obtained at each location are shown. **b.** map showing the corresponding chromitite sample locations; note the location of the suggested Trans-Herbeira Fault (THF). Location 2 corresponds to chromitite-bearing dunite pods in harzburgite (Moreno et al. 2001).
...
Whether or not type-1 and type-2 are cogenetic remains uncertain, and both scenarios are not mutually exclusive. 
- Evidence in favour of the former scenario (**Fig_petrogenetic-model_a**) includes WR and mineral chemistry that suggest they can be related to the same melt differentation/melt-rock interaction trend (_e.g._ **Fig_mineral-chemistry-pyroxenites_b**). They also exhibit mostly homogeneous age-corrected radiogenic isotope compositions consistent with a single batch of parental melt (_e.g_ Gravestock 1992, Santos et al., 2002, Tilhac et al. 2017). In particular, the LREE is correlated with Nd-isotope compositions and the different types of pyroxenites plot along the same isochron (Tilhac et al. 2017). 
- Evidence that supports the latter scenario (**Fig_petrogenetic-model_b**) includes field observations in the only large outcrop surfaces exposed on the shore at the bottom of the *Herbeira* cliffs where massive (type-2) pyroxenites are seen as thick layers, relatively undeformed compared to type-1/-3 pyroxenites (**Fig-pyroxenites-cliff**). Alternatively, these observations could be accounted for by a prerential localization away from thick (more competent) pyroxenite layers. Also in favour of the latter scenario, Gravestock (1992) concluded that the websterites (comparable to type 2) were formed after the clinopyroxenites (comparable to type-1), suggesting that percolation of the websteritic melt was responsible for selective LREE enrichment of the clinopyroxenites.

<img src="fieldguide_figures/pyroxenites-cliff.png"
style="max-width: 100%; max-height: 500px; height: auto;"/>

**Fig-pyroxenites-cliff**. Outcrop on the shoreline at the bottom of the *Herbeira* cliffs exposing field relationships between the different types of pyroxenites (Tilhac, 2017). (**a.**) Overview of the outcrop highlighting the massive field occurrence of type-2 pyroxenites. (**b.**) Detail view of strongly deformed pyroxenite-dunite association showing foliated type-3 pyroxenites and shear zones associatiated with late pyroxenite dykes.

In this context, the origin of the Opx-rich (type-4) pyroxenites is not well accounted for by the model pictured above. Their high Mg# and Cr# and their field occurrence associated with chromitites point to a very primitive character, suggesting that they are more likely to be related to type-2 pyroxenites (see **Stop 4.2**). This argument would support the scenario upon which type-1 and type-2/-4 pyroxenites are not directly cogenetic.

As for the foliated (type-3) pyroxenites, their petrogenesis clearly involves a deformational, metamorphic and metasomatic overprint not relevant to this discussion on the nature of the protoliths (see **Stop 3.3**).

#### Parental melts and source constraints

Cabo Ortegal pyroxenites have markedly higher SiO<sub>2</sub>, CaO, Cr and Sc contents and lower Al<sub>2</sub>O<sub>3</sub>, TiO<sub>2</sub> and Ni contents than pyroxenites from most ultramafic massifs (_e.g._ Horoman, Ronda, Beni Boussera, Lanzo, Lherz). High concentrations of compatible elements (_e.g._ Cr<sub>2</sub>O<sub>3</sub> >0.4%) suggest that they crystallized from primitive melts. The pyroxenites are also characterised by low-Al pyroxenes indicating low Al/Si parental melts such as boninites or high-Mg# andesites. Very high CaO/Al<sub>2</sub>O<sub>3</sub> more specifically suggests high-Ca boninites or ultra-calcic picrites. The most primitive (type-1) pyroxenites indeed exhibit high Cpx/Opx ratios, pointing to crystallization along a Cpx–Ol cotectic line expected from ultra-calcic picrites (**Fig_normative-compositions**). In contrast, the more evolved (type-2) websterites rather exhibit a bonitic affinity and are comparable with experimental pyroxenitic cumulates of hydrous basaltic andesite and high-Mg# andesite at 1.2 GPa (Müntener et al. 2001). The implications of the two scenarios considered above as as follows:

- On the one hand, chromitites, type-4 and type-2 pyroxenites may have originated from a boninitic parental melt with a crystallization sequence of Ol (+Cr-Spl) > Opx > Cpx (Crawford et al. 1989), distinct to the early appearance of Cpx akin to an ultra-calcic picrites, as inferred from type-1 pyroxenites.
- On the other hand, the cogeneticity of type-2 and type-1 pyroxenites would imply that the picritic melt is parental to the boninitic melt. 

These considerations relate to the ongoing debate on the primary nature of arc magmas, and bonitites in particular (_e.g._ Cooper et al. 2010, Bénard et al. 2016, and references therein).
...
These pyroxenites are more evolved with 20-21% MgO, 3-6% Al<sub>2</sub>O<sub>3</sub> and Cpx Mg# of 0.88-0.92 (**Fig_mineral-chemistry-**). Type-2 pyroxenites plot along the En-CaTs join on the Fo-CaTs-Qz diagram, similarly to experimental cumulates of hydrous basaltic andesites (Müntener et al. 2001). Their Ol-free, lower Cpx/Opx modal compositions suggest that they either crystallized from an initially Si-saturated (boninitic) melt or that they represent a more advanced product of the melt-peridotite interaction that produced type-1 pyroxenites, upon which Ol was entirely consumed by a peritectic reaction. Higher and more variable melt/rock ratios in type-2 pyroxenites are indicated by variable LREE enrichment over nearly flat HREE (**Fig_REE-type2**), ascribed to chromatographic re-equilibration with incompatible-element enriched residual melts (Tilhac et al. 2016). This enrichment was potentially enhanced by porosity-reducing reactions such as the crystallization of hydrous residual melts in a process similar to the percolative fractional crystallization model of Harte et al. (1993), as suggested by higher proportions of late-magmatic Amp in type-2 pyroxenites. Accordingly, outward percolation of these melts probably metasomatized the host peridotites as well as pre-existing pyroxenites (potentially including type 1).A positive correlation was indeed observed between the amount of pyroxenites and the extent of LREE enrichment in the  harzburgites (Gravestock, 1992).
...
Some type-3 pyroxenites may represent the deformed (foliated) products of metasomatized (amphibolitzed) type-1 pyroxenites. This is suggested, for instance, by transitional samples that exhibit increasing Amp and progressive LREE and LILE enrichment characteristic of chromatographic re-equilibration (**Fig_CO-010**) .

<img src="fieldguide_figures/ree-profile.png"
style="max-width: 50%; max-height: 500px; height: auto;"/>

**Fig_CO-010**.  Profile of REE compositions in Cpx across a composite  sample of type-1 and type-3 pyroxenite (CO-010). Note the wehrlite streak preserved within the pyroxenite layer on the left-hand side (Tilhac et al. 2016).

However, most of them are interpreted as the deformed and hydrated (amphibolitized) products of the other two types, preferentially type-1 pyroxenites where dunite lenses and layers provided preferential pathways for fluids percolation and deformation localization (**Fig_amphibolitization**). Accordiongly, where sheath folds affect pyroxenites (in the lower part of the pyroxenite-rich domain), the latter are systematically of type 3, and particularly amphibolitized. This observation suggests that most of the hydration was syn-kinematic of the high-shear strain deformation episode (D<sub>1</sub>) and that metamorphic amphibolitization (which produced undeformed idiomorphic Amp) is mostly post-kinematic and contemporaneous to the regional amphibolite-facies metamoprhism during exhumation stage D<sub>3</sub>.
...
**Fig_map-Monterrubio-Perez**. Map of the chromitite-rich part of the upper dunite, where dunite alternate with diffuse bands of wehrlite (Monterrubio Perez, 1991). The edge of the Herbeira cliffs is shown for reference.
...
> Add type-4 REE compositions (appendix A1 Tilhac et al. 2016)
